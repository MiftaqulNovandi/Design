...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a class="" href="browse_admin.php">Browse</a>
...
<div id="maincontainer">
  ...
  <h1 align="center">Data User Statistik UPD Kabupaten Ngawi</h1>
  <h2>Seluruh UPD Tahun 2018 (list was updated 08.2015)</h2>
 ...
 <table class="table table-bordered">
  <thead>
   <tr>
    ...
    <th><font face="Arial">Nama</font></th>
  ...
  $q="select count(*) \"total\"  from login";
  ...
  $k=($page_cur-1)*$dis;
  $q="SELECT * FROM login ORDER BY id ASC limit $k,$dis";
  $ros=mysql_query($q,$link);
  $i=1;
  while($row=mysql_fetch_array($ros))
  {
    ...
    echo '<td align=center>' . $row['username'];
    echo "<td align=center><a title='Click here to delete file.'
         href='delete_user.php?id={$row['id']}' onclick='return checkDelete()'>Delete </a>"; 
    echo '</tr>';
    $i++;
  }
  echo '</table>';
  ...
  if($page_cur>1)
  {
   echo '<a href="browse_admin.php?page='.($page_cur-1).'" style="cursor:pointer;color:DeepSkyBlue ;" ><input style="cursor:pointer;background-color:DeepSkyBlue;border:1px black solid;border-radius:5px;width:120px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Previous "></a> ';
     }
  else
  {
  ...
  for($i=1;$i<$total_page;$i++)
  {
    ...
    {
    echo '<a href="browse_admin.php?page='.$i.'"> <input style="cursor:pointer;background-color:DeepSkyBlue ;border:1px black solid;border-radius:5px;width:30px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value="'.$i.'"> </a> ';
  ...
  if($page_cur<$total_page)
  {
    ...
    echo '<a href="browse_admin.php?page='.($page_cur+1).'"><input style="cursor:pointer;background-color:DeepSkyBlue ;border:1px black solid;border-radius:5px;width:90px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Next "></a>';
