...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a class="active"href="insert_user.php">Insert User</a>
...
<br>
     ...
     <div class="container home">
      <br>
    <h3><center> INSERT USER </center> </h3> </font>

        <form id="form3" enctype="multipart/form-data" method="post" action="insert_proccess.php">
             <table class="table table-bordered">           
                <tr>
                    <td>  <label>Nama OPD: </label>  </td>
                    <td>  <input type="text" name="nama" id="nama" class="input-medium"  
                   required autofocus placeholder="Nama OPD"/>  </td>
                </tr>
                <tr>
                    <td valign="top" align="left">Username:</td>
                    <td valign="top" align="left"><input type="text" name="username" cols="50" rows="10" id="username"  
          placeholder="Username"
          class="input-medium" required></textarea></td>
                </tr>
                <tr>
                    <td valign="top" align="left">Password:</td>
                    <td valign="top" align="left"><input type="Password" name="Password" cols="50" rows="10" id="Password"  
          ...
          class="input-medium" required></textarea></td>
           ...
           title="Click here to insert the data." value="Insert User" align="center"/> </td>
                </tr>
            </table>
        </form>
    </div>
