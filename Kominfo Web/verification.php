...
<script language="JavaScript" type="text/javascript">
  function checkVerify(){
    return confirm('Are you sure verification this file?');
  }
</script>
</head>
<body>
...
<div class="header">
  ...
  <div class="header-right">
  	<a class="active" href="verification.php">Verification</a>
...
<h3><center></center> </h3>
 ...
 <table class="table table-bordered">
  ...
  $q="select count(*) \"total\"  from verification";
  ...
  $k=($page_cur-1)*$dis;
  $q="SELECT * FROM verification ORDER BY subject ASC limit $k,$dis";
  $ros=mysql_query($q,$link);
  $i=1;
  while($row=mysql_fetch_array($ros))
  {
    ...
    echo "<td align=center><a title='Click here to verification file.'
         href='verification_process.php?id={$row['id']}' onclick='return checkVerify()'>Verification </a>"; 
    echo '</tr>';
    $i++;
  }
  echo '</table>';
